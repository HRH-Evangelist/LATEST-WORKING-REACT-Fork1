...
import { User, Briefcase, MessageSquare, Mail, Linkedin, Globe, CreditCard, Link2, Loader2, Eye } from 'lucide-react';
...
function EditProfile() {
  ...
  const handlePreview = () => {
    ...
    window.location.href = `/user-nfc?id=${sessionCardId}&preview=true`;
  };
