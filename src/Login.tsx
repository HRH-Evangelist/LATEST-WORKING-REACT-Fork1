...
import { Mail, Lock, CreditCard, Loader2, Eye, EyeOff } from 'lucide-react';
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="••••••••"
                className="w-full pl-11 pr-12 py-3 md:py-3.5 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition-all text-base"
              />
              <button
                type="button"
